...
<div class="w3-sidebar w3-bar-block w3-card w3-animate-left" style="display:none" id="mySidebar">
  ...
  <a href="#" class="w3-bar-item w3-button"><i class = "uil uil-estate"></i>Home</a>
  ...
  <a href="#" class="w3-bar-item w3-button"><i class = "uil uil-signin"></i>Login</a>
  <a href="#" class="w3-bar-item w3-button"><i class = "uil uil-signout"></i>Logout</a>
</div>
